...
Le Sprint 2, couvrant la période de novembre 2024, a pour objectif principal
l'implémentation de l'agent planificateur IA. Lors du Sprint Planning, les
User Stories US-01 et US-02 ont été sélectionnées depuis le Product Backlog
et intégrées au Sprint Backlog. L'objectif du Sprint est de livrer une machine
à états LangGraph fonctionnelle avec les 18 outils LLM opérationnels.
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.85\textwidth]{diagrams/fig_04_langgraph_routing.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.9\textwidth]{diagrams/fig_04_tool_execution_flow.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.9\textwidth]{diagrams/screen_04_rag_search_result.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.9\textwidth]{diagrams/fig_04_fast_pipeline.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.85\textwidth]{diagrams/screen_04_chat_plan_output.png}
...
À l'issue du Sprint 2, les User Stories US-01 et US-02 ont été démontrées
à l'encadrant et validées conformément à la Definition of Done. Le livrable
principal est l'agent planificateur LangGraph opérationnel avec ses 18 outils
LLM, le pipeline RAG multilingue et le système de mémoire conversationnelle.

La Sprint Retrospective a mis en évidence les points suivants :
\begin{itemize}
  \item \textbf{Points positifs} : la modularité de LangGraph a facilité
        l'ajout incrémental des outils sans régression.
  \item \textbf{Points d'amélioration} : le temps de réponse du cross-encoder
        en mode synchrone a nécessité une refactorisation vers des threads CPU.
  \item \textbf{Action pour Sprint 3} : introduire le cache de résultats RAG
        pour réduire la latence sur les requêtes répétées.
\end{itemize}

...
la conception de l'architecture globale en couches (section~2.4), la spécification du schéma de
base de données (section~2.5), la définition des contrats API REST (section~2.6), et enfin les
considérations de sécurité et de gestion des données (section~2.7).

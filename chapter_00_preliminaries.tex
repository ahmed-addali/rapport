...
% ────────────────────────────────────────────────────────────────────────────
\begin{titlepage}
    % Cette commande dit à LaTeX d'ignorer toutes les marges et de centrer sur la page physique
    \begin{tikzpicture}[remember picture, overlay]
        \node at (current page.center) {%
            \includegraphics[width=\paperwidth, height=\paperheight, keepaspectratio=false]{images/Page_de_Garde_DNI.png}%
        };
    \end{tikzpicture}
\end{titlepage}
...
\begin{large}
{\large \textit {Je dédie ce projet} \\
\setlength{\parskip}{20pt}
À mes êtres les plus chers,
\setlength{\parskip}{12pt}
Mes parents, mes piliers et mes sources d'inspiration.

\setlength{\parskip}{12pt}
Aucun hommage ne pourrait être à la hauteur de vos sacrifices, de l'amour
et de l'affection dont vous n'avez cessé de m'entourer. Vos encouragements
constants ont toujours été pour moi les plus précieux.

\setlength{\parskip}{12pt}
À ma chère famille, pour son soutien inconditionnel et son amour inébranlable tout au long de mon parcours.

\setlength{\parskip}{12pt}
À mes amis et camarades de classe, pour les moments de partage, les échanges d'idées et les défis relevés ensemble.

\setlength{\parskip}{12pt}
À mes enseignants et encadrants, pour leur expertise, leurs conseils éclairés et leur motivation à me pousser toujours plus loin.

\setlength{\parskip}{12pt}
À toutes les personnes qui ont contribué de près ou de loin à la réalisation de ce projet, je vous exprime ma gratitude sincère.

\setlength{\parskip}{12pt}
Enfin, je dédie ce travail à moi-même, en reconnaissance de mon engagement, de ma détermination et de ma persévérance.

\setlength{\parskip}{12pt}
Je vous adresse mes vœux les plus chaleureux pour un avenir radieux, rempli de bonheur et de succès.
...
\begin{center}
\begin{large}
Je commence par exprimer ma profonde gratitude et mes sincères remerciements à Allah, le Tout-Puissant, de m'avoir accordé la santé et la vie pour être ici aujourd'hui.

Au terme de ce travail, je tiens à adresser mes remerciements les plus sincères à :

\begin{flushleft}
\textbf{Madame Nadra Benromdhan}, pour sa considération, sa patience et sa bienveillance tout au long de la réalisation de ce projet. Ses encouragements et ses conseils lucides et pertinents ont été d'une grande valeur pour moi.
\end{flushleft}

\begin{flushleft}
\textbf{M. Nizar Tenzekhti}, le Directeur Général de Tenovate Services, pour son accueil chaleureux et la confiance qu'il m'a accordée dès mon arrivée dans l'entreprise. Sa collaboration et son soutien ont été précieux tout au long de cette expérience.
\end{flushleft}

Enfin, je tiens également à exprimer mes plus sincères remerciements aux membres du jury pour avoir accepté d'évaluer ce modeste travail. Leur expertise et leurs commentaires constructifs ont contribué à améliorer ce projet.
\end{large}
\end{center}
...
et disposant des outils appelables par le LLM, couvrant la gestion
...
BAAI/bge-reranker-v2-m3. Le second sous-système est un \textbf{moteur de recommandation Hybrid Thompson Sampling} exploitant une double segmentation sémantique (clé globale de destination et clé utilisateur personnalisée), un mélange hybride pondéré par un poids de personnalisation dynamique ($w = \min(0.8, N/40)$) résolvant le démarrage à froid, un pipeline de classement post-scoring en dix étapes, et un apprentissage bayésien en ligne instantané à partir de signaux comportementaux calibrés.
...
incrémentale déclenchée par les Triggers. Ce système contribue à
...
\vspace{0.8cm}
\noindent\textbf{Mots-clés~:} Agent LLM, LangGraph, RAG multilingue, Hybrid Thompson Sampling, MAB bayésien, Recommandation personnalisée.
...
cross-encoder reranking. The second sub-system is a \textbf{Hybrid Thompson Sampling
recommender} leveraging a dual semantic segmentation (global destination key and personalized user key), a hybrid blending weighted by a dynamic personalization weight ($w = \min(0.8, N/40)$) that elegantly solves the cold start problem, a ten-step post-scoring ranker pipeline, and instant online bayesian learning from calibrated behavioral feedback.
...
Triggers events. The system contributes a joint approach to
AI-assisted trip planning and online learning from real-time behavioural
signals for the Djerba tourism market.

\vspace{0.8cm}
\noindent\textbf{Keywords:} LLM Agent, LangGraph, Multilingual RAG, Hybrid Thompson Sampling, Bayesian MAB, Personalised Recommendation.
...
%   2.5 Bandits multi-bras et algorithme Thompson Sampling Hybride .......... pp
...
%   4.4 Les outils LLM-callable ........................................ pp
...
%
% Chapitre 5 — Implémentation du moteur de recommandation Hybrid Thompson Sampling
%   5.1 Introduction ...................................................... pp
%   5.2 Modélisation mathématique et conjugaison Beta-Binomiale ........... pp
%   5.3 Mélange hybride et échantillonnage ................................ pp
...
\begin{longtable}{@{} p{3.2cm} p{11.5cm} @{}}
    ...
    2TUP        & Two-Track Unified Process \\[3pt]

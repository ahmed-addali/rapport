...
\begin{titlepage}
    ...
    \begin{tikzpicture}[remember picture, overlay]
        \node at (current page.center) {%
            % Remplacement de .png par .pdf ici
            \includegraphics[width=\paperwidth, height=\paperheight, keepaspectratio=false]{images/Page de Garde DNI 2024.pdf}%
        };
    \end{tikzpicture}
\end{titlepage}
...
\setlength{\parskip}{12pt}
Je vous adresse mes voeux les plus chaleureux pour un avenir radieux, rempli de bonheur et de succès.
...
\begin{flushleft}
\textbf{Madame Nadra Ben romdhane}, pour sa considération, sa patience et sa bienveillance tout au long de la réalisation de ce projet. Ses encouragements et ses conseils lucides et pertinents ont été d'une grande valeur pour moi.
\end{flushleft}

\begin{flushleft}
\textbf{M. Nizar Tenzekhti}, pour son accueil chaleureux et la confiance qu'il m'a accordée dès mon arrivée dans l'entreprise. Sa collaboration et son soutien ont été précieux tout au long de cette expérience.
\end{flushleft}
...
LangGraph comportant quatre noeuds (THINK, EXECUTE\_TOOL, VALIDATE, RESPOND)
...
vector ($\phi = x_{\text{user}} \otimes x_{\text{tags}}$, dimension~360), a
...
%   4.3 Noeud THINK — raisonnement du LLM .................................. pp
%   4.4 Les outils LLM-callable ........................................ pp
%   4.5 Noeud VALIDATE — validation des sorties ............................ pp
%   4.6 Noeud RESPOND — génération de la réponse ........................... pp
